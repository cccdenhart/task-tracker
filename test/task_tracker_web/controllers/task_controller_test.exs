defmodule TaskTrackerWeb.TaskControllerTest do
  ...
  @create_attrs %{description: "some description", duration: 42, is_complete: true, title: "some title", username: "some username"}
  @update_attrs %{description: "some updated description", duration: 43, is_complete: false, title: "some updated title", username: "some updated username"}
